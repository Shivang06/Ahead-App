            ...
            <div style={{ height: "550px" }} className='bg-bgBlue relative rounded-3xl flex flex-col md:flex-row overflow-hidden'>
                ...
                <div className='basis-1/2 flex items-center justify-center w-full'>
                    ...
                    <motion.div
                        ...
                        {/* voilet ghost */}
                        <motion.div whileInView="visible" viewport={{ once: true }} animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ bottom: "-22px", right: "50%" }} className='absolute h-17 w-14'><Image height={100} width={100} src="/newGhost.png" alt="" /></motion.div>
                    </motion.div>
                </div>
